          ...
          <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between space-y-4 lg:space-y-0">
            <div>
              ...
              <p className="text-sage-600">
                Find peace through guided meditation and mindful breathing
              </p>
            </div>
          ...
          {favorites.length > 0 && (
            <div className="mb-8">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                {favorites.slice(0, 3).map((session, index) => (
                  <motion.div
                    key={session.id}
          ...
          <div>
            ...
            {filteredSessions.length === 0 ? (
              <Card className="text-center py-12">
                ...
                <h3 className="text-lg font-display text-moss-800 mb-2">
                  No sessions found
                </h3>
            ...
            <Card variant="elevated" className="bg-gradient-to-br from-moss-50 to-sage-50">
              <div className="p-8 text-center">
                ...
                <p className="text-sage-600 mb-6 max-w-md mx-auto">
                  Start with our beginner-friendly sessions designed to introduce you to the practice of mindfulness
                </p>
                <Button
                  variant="primary"
                  icon="Play"
                  onClick={() => {
                    ...
                    if (beginnerSession) handlePlaySession(beginnerSession)
                  }}
                >
                  Start Your Journey
                </Button>
